...
const DEADLINE = new Date('2026-04-10T15:15:00+08:00')
      ...
      <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="rounded-2xl border border-gray-dark/20 bg-white/[0.02] backdrop-blur-sm p-8 space-y-6">
            ...
            {isExpired && (
              <p className="text-center text-red-400/70 text-xs">提交已截止（4 月 10 日 15:15），仅可查看已提交的项目</p>
            )}
          </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="text-center max-w-md relative z-10">
          ...
          <p className="text-gray-dark text-sm mb-2">提交截止时间为 4 月 10 日 15:15</p>
